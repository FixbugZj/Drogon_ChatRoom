...
class userlogin : public drogon::HttpController<userlogin>
{
  public:
    ...
    ADD_METHOD_TO(userlogin::loginPage, "/login", Get); 
    ADD_METHOD_TO(userlogin::dologin,"/login",Post);
    ADD_METHOD_TO(userlogin::doregister,"/register",Post);
    ...
    void dologin   (const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback,drogon_model::db::Users) const; //rogon_model::db::Users
    
    void doregister(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback,drogon_model::db::Users,User user) const; //drogon_model::db::Users
