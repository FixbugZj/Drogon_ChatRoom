...
class Historymessages
{
  public:
     ...
     */
    explicit Historymessages(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Historymessages(const Json::Value &pJson) noexcept(false);
     ...
     */
    Historymessages(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Historymessages>;
    friend drogon::orm::BaseBuilder<Historymessages, true, true>;
    friend drogon::orm::BaseBuilder<Historymessages, true, false>;
    friend drogon::orm::BaseBuilder<Historymessages, false, true>;
    friend drogon::orm::BaseBuilder<Historymessages, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Historymessages>;
#endif
