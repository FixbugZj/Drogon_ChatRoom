...
class Groupuser
{
  public:
     ...
     */
    explicit Groupuser(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Groupuser(const Json::Value &pJson) noexcept(false);
     ...
     */
    Groupuser(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const std::string &getValueOfGrouprole() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getGrouprole() const noexcept;
    ///Set the value of the column grouprole
    void setGrouprole(const std::string &pGrouprole) noexcept;
    void setGrouprole(std::string &&pGrouprole) noexcept;
    void setGrouproleToNull() noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Groupuser>;
    friend drogon::orm::BaseBuilder<Groupuser, true, true>;
    friend drogon::orm::BaseBuilder<Groupuser, true, false>;
    friend drogon::orm::BaseBuilder<Groupuser, false, true>;
    friend drogon::orm::BaseBuilder<Groupuser, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Groupuser>;
#endif
