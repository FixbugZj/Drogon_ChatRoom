...
chat_tmp_stream<<"\n";
	...
	chat_tmp_stream << "                <button onclick=\"sendMessage()\">发送</button>\n";
	chat_tmp_stream << "            </div>\n";
	chat_tmp_stream << "        </div>\n";
	chat_tmp_stream << "    </div>\n";
chat_tmp_stream<<"\n";
	chat_tmp_stream << "    <script>\n";
	chat_tmp_stream << "        function toggleGroup(groupId) {\n";
	chat_tmp_stream << "            var group = document.getElementById(groupId);\n";
	chat_tmp_stream << "            group.classList.toggle('active');\n";
	chat_tmp_stream << "        }\n";
chat_tmp_stream<<"\n";
	chat_tmp_stream << "        function sendMessage() {\n";
	chat_tmp_stream << "            var messageInput = document.getElementById('messageInput');\n";
	chat_tmp_stream << "            var messageContent = messageInput.value.trim();\n";
	chat_tmp_stream << "            if (messageContent !== '') {\n";
	chat_tmp_stream << "                var message = {\n";
	chat_tmp_stream << "                    type: 'text',\n";
	chat_tmp_stream << "                    content: messageContent,\n";
	chat_tmp_stream << "                    timestamp: new Date().toISOString()\n";
	chat_tmp_stream << "                };\n";
	chat_tmp_stream << "                displayMessage(message, 'sent');\n";
	chat_tmp_stream << "                messageInput.value = '';\n";
	chat_tmp_stream << "                // 模拟接收方发送消息的延迟\n";
	chat_tmp_stream << "                setTimeout(receiveMessage, 1000);\n";
	chat_tmp_stream << "            }\n";
	chat_tmp_stream << "        }\n";
chat_tmp_stream<<"\n";
	chat_tmp_stream << "        function receiveMessage() {\n";
	chat_tmp_stream << "            var message = {\n";
	chat_tmp_stream << "                type: 'text',\n";
	chat_tmp_stream << "                content: '收到你的消息了！',\n";
	chat_tmp_stream << "                timestamp: new Date().toISOString()\n";
	chat_tmp_stream << "            };\n";
	chat_tmp_stream << "            displayMessage(message, 'received');\n";
	chat_tmp_stream << "        }\n";
chat_tmp_stream<<"\n";
	chat_tmp_stream << "        function displayMessage(message, messageType) {\n";
	chat_tmp_stream << "            var chatBox = document.getElementById('chatBox');\n";
	chat_tmp_stream << "            var messageDiv = document.createElement('div');\n";
	chat_tmp_stream << "            messageDiv.classList.add('message', messageType);\n";
	chat_tmp_stream << "            var messageContentDiv = document.createElement('div');\n";
	chat_tmp_stream << "            messageContentDiv.classList.add('message-content');\n";
	chat_tmp_stream << "            messageContentDiv.textContent = message.content;\n";
	chat_tmp_stream << "            messageDiv.appendChild(messageContentDiv);\n";
	chat_tmp_stream << "            chatBox.appendChild(messageDiv);\n";
	chat_tmp_stream << "            // 滚动到最底部\n";
	chat_tmp_stream << "            chatBox.scrollTop = chatBox.scrollHeight;\n";
	chat_tmp_stream << "        }\n";
	chat_tmp_stream << "    </script>\n";
	chat_tmp_stream << "</body>\n";
chat_tmp_stream<<"\n";
